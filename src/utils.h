...
static constexpr const int LEFT_CONTROL  = 43;

static constexpr const int COUNT_OF_KEYS = 44;
...
static const QMap<int, int> KeysMapper =
{
    ...
    {static_cast<int>(Qt::Key_Control),    LEFT_CONTROL}
};
}

namespace SCREEN
{
    static constexpr const QSize LOGICAL_SIZE  = QSize(12, 10);
    static constexpr const QSize CELL_SIZE     = QSize(64  , 64  );
...
namespace COLOR_STYLE
{
    ...
    static const QColor BACKGROUND = QColor(99, 92, 92);
